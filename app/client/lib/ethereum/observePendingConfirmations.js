    ...
    collectionObservers[collectionObservers.length] = PendingConfirmations.find({}).observe({
        ...
        */
        added: function(document) {
            ...
            if(typeof morningstar !== 'undefined' && document.confirmedOwners && document.confirmedOwners.length) {
                morningstar.menu.setBadge(TAPi18n.__('wallet.app.texts.pendingConfirmationsBadge'));
            }
        },
        /**
