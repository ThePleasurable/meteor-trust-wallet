...
Template['elements_account'].helpers({
    ...
    */
    'account': function(){
        return EntrustAccounts.findOne(this.account) || Wallets.findOne(this.account) || CustomContracts.findOne(this.account);
    },
    /**
    Get all tokens
    ...
    'new': function() {
        if(this.new) {
            ...
            Meteor.setTimeout(function() {
                EntrustAccounts.update(id, {$unset: {new: ''}});
    ...
    */
    'creating': function(){
        return (!this.address || this.imported || (blocksForConfirmation >= EntrustBlocks.latest.number - (this.creationBlock - 1) && EntrustBlocks.latest.number - (this.creationBlock - 1) >= 0));
    },
    /**
    ...
    */
    'unConfirmed': function() {
        ...
        var currentBlockNumber = EntrustBlocks.latest.number,
