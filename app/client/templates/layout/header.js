...
Template['layout_header'].helpers({
    ...
    */
    'formattedBlockNumber': function() {
        return numeral(EntrustBlocks.latest.number).format('0,0');
    },
    /**
    ...
    */
    'timeSinceBlock': function () {
        ...
        if (EntrustBlocks.latest.timestamp == 0 
            || typeof EntrustBlocks.latest.timestamp == 'undefined')   
            return false;

        var timeSince = moment(EntrustBlocks.latest.timestamp, "X");
        var now = moment();
